...
Although those popular type definitions have been existing in the Linux kernel for a while (except for `iN`, replaced with `sN`, e.g. `s16` instead of `i16`), [Rust](https://doc.rust-lang.org/reference/types/numeric.html) seems to have democratized them even more. Other modern programming langages have been following the trend of crude type names like [Zig](https://ziglang.org/documentation/0.15.2/#Primitive-Types).
